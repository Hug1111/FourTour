<div class="w-11/12 mx-auto my-0">
                    <p class="text-2xl my-3">Edit Uu dai </p>
                    <form action="index.php?act=up_ud" method="post" class="w-2/3">
                        <table class="w-full bg-slate-100 rounded-lg">
                            <tr>
                                <td>
                                    <p class="px-2 text-lg">Tên Slider</p>
                                    <input class="px-2 py-[2px] border w-11/12 mx-2" type="text" name="name" value="<?php echo $uu_dai['name'] ?>">
                                    <p class="text-sm text-red-400 mx-2">moi nhap ten</p>
                                </td>
                                <td>
                                    <p class="px-2 text-lg">Gia tri</p>
                                    <input class="px-2 py-[2px] border w-11/12 mx-2" type="number" name="giaTri" placeholder="%" value="<?php echo $uu_dai['giaTri'] ?>">
                                    <p class="text-sm text-red-400 mx-2 ">moi nhap ten</p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                                    <div class="flex my-3">
                                        <div class="mx-2">
                                            ...
                                            <input class="rounded-xl mx-2" type="date" value="<?php echo $uu_dai['ngaybatdau'] ?>" name="start">
                                        </div>
                                        <div class="mx-2">
                                            <span>Ngay ket thuc</span>
                                            <input  class="rounded-xl mx-2" type="date" value="<?php echo $uu_dai['ngayketthuc'] ?>" name="end">
                                        </div>
                                    </div>  
                                </td>
                            </tr>
                        </table>
                        <input type="hidden" name="id" value="<?php echo $uu_dai['id_UD'] ?>">
                        <div class="flex">
