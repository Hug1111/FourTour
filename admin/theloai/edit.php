<div class="w-11/12 mx-auto my-0">
                    <p class="text-2xl my-3">Edit Slider mới</p>
                    <form action="index.php?act=update_tl" method="post" class="w-2/3">
                        <table class="w-full bg-slate-100 rounded-lg">
                            <tr>
                                <td>
                                    <p class="px-2 text-lg">Tên loai tour</p>
                                    <input class="px-2 py-[2px] border w-11/12 mx-2" type="text" name="name" value="<?php echo $loai['name'] ?>">
                                    <p class="text-sm text-red-400 mx-2">moi nhap ten</p>
                                </td>
                                <input type="hidden" name="id" value="<?php echo $loai['id_loai'] ?>">
                            </tr>
                        </table>
                        <div class="flex">
