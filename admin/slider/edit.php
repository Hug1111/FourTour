<div class="w-11/12 mx-auto my-0">
                    <p class="text-2xl my-3">Cap nhat Slider </p>
                    <form action="index.php?act=update_sl" method="post"  enctype="multipart/form-data" class="w-2/3">
                        <table class="w-full bg-slate-100 rounded-lg">
                            <tr>
                                <td>
                                    <p class="px-2 text-lg">Tên Slider</p>
                                    <input class="px-2 py-[2px] border w-11/12 mx-2" type="text" name="name" value="<?php echo $slider['name_slider'] ?>">
                                    <p class="text-sm text-red-400 mx-2">moi nhap ten</p>
                                </td>
                                <td>
                                    <p class="px-2 text-lg">Url</p>
                                    <input class="px-2 py-[2px] border w-11/12 mx-2" type="text" name="url" value="<?php echo $slider['url'] ?>">
                                    <p class="text-sm text-red-400 mx-2 ">moi nhap ten</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td><img class="max-w-[200px] min-h[100px]"  src="../image/<?php echo $slider['image_sl'] ?>" alt="">
                                    <input type="hidden" name="img" value="<?php echo $slider['image_sl'] ?>">
                            ...
                            <tr>
                                <td colspan="2">
                                    ...
                                    <textarea name="moTa" id="" class="w-11/12 mx-7" cols="50" rows="5"><?php echo $slider['moTa'] ?></textarea>
                                </td>
                            </tr>
                        </table>
                        <div class="flex">
