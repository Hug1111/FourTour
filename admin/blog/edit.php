<div class="w-11/12 mx-auto my-0 ">
                    <p class="text-3xl my-4 border-b-2">Sửa bài viết</p>
                    <form action="index.php?act=update_b" method="post" enctype="multipart/form-data" class="w-2/3 mx-auto ">
                                    <div class="pt-2">
                                        <p class="px-2 text-xl">Tiêu đề</p>
                                        <input class="px-2 py-[2px] border border-slate-700 w-11/12 mx-2" type="text" name="name" value="<?php echo $blog['title'] ?>" placeholder="Tiêu đề">
                                    </div>
                                    <div class="pt-2">
                                        <p class="px-2 text-xl">Ảnh</p>
                                        <input class="text-sm ml-2" type="file" name="file">

                                        <img class="max-w-[200px] min-h[100px]"  src="../image/<?php echo $blog['image_b'] ?>" alt="">
                                        <input type="hidden" name="img" value="<?php echo $blog['image_b'] ?>">
                                        <input type="hidden" name="id" value="<?php echo $blog['id_blog'] ?>">
                                    </div>
                                    <div class="pt-2">
                                        <p class="px-2 text-xl">Nội dung</p>
                                        <textarea name="noiDung" id="" class="w-11/12 p-2 mx-2 border border-slate-700" cols="90" rows="10"><?php echo $blog['content'] ?></textarea>
                                    </div>
